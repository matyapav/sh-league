...
if ('C:\Program Files (x86)\EasyPHP-DevServer-14.1VC11\data\localweb\projects\quickstart\pear ' != '@'.'include_path'.'@ ') {
    ini_set('include_path', trim('C:\Program Files (x86)\EasyPHP-DevServer-14.1VC11\data\localweb\projects\quickstart\pear '). PATH_SEPARATOR .  get_include_path());
    $raw = false;
} else {
