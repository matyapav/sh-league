...
FOR %%x IN ("C:\Program Files (x86)\EasyPHP-DevServer-14.1VC11\data\localweb\projects\quickstart\pear") DO (if %%x=="%PMTPMTPMT%" GOTO :NOTINSTALLED)

REM Check PEAR global ENV, set them if they do not exist
IF "%PHP_PEAR_INSTALL_DIR%"=="" SET "PHP_PEAR_INSTALL_DIR=C:\Program Files (x86)\EasyPHP-DevServer-14.1VC11\data\localweb\projects\quickstart\pear"
IF "%PHP_PEAR_BIN_DIR%"=="" SET "PHP_PEAR_BIN_DIR=C:\Program Files (x86)\EasyPHP-DevServer-14.1VC11\data\localweb\projects\quickstart"
IF "%PHP_PEAR_PHP_BIN%"=="" SET "PHP_PEAR_PHP_BIN=C:\Program Files (x86)\EasyPHP-DevServer-14.1VC11\binaries\php\php_runningversion\php.exe"
GOTO :INSTALLED
